...
---
# Generated by setup_infra.sh — do not commit (gitignored)
# Gateway IPs are sourced from NetBox custom fields (gateway_ip on circuit terminations)
# rather than hardcoded here. See IPLC-GB-AT-PRI and IPLC-GB-AT-SEC A-end terminations.
